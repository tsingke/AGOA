...
This paper proposes the Adversarial Game Optimization Algorithm (AGOA), a novel metaheuristic framework inspired by adversarial game dynamics, designed to address challenges such as premature convergence and inadequate global exploration in high-dimensional, multimodal optimization problems. By introducing a dynamic role-based population partitioning strategy that adaptively integrates elite guidance, ordinary exploration, and reverse feedback mechanisms, AGOA achieves a robust balance between exploration and exploitation. Extensive experiments on CEC 2017 and CEC 2022 benchmarks, as well as a UAV 3D path planning application, demonstrate its superior convergence accuracy, search efficiency, and robustness over 75 state-of-the-art algorithms. Additionally, theoretical analysis rigorously proves AGOA’s convergence to the global optimum under practical conditions, underscoring its strong generalization capability and significant potential for real-world engineering optimization tasks. The source code of AGOA is openly available at https://github.com/tsingke/AGOA.
